...
Manager.NAMES = {
	...
	WIN_MODAL = "WIN_MODAL",
	WIN_MODAL_GUI = "WIN_MODAL_GUI",
	HELP_MODAL = "HELP_MODAL",
	HELP_MODAL_GUI = "HELP_MODAL_GUI",
	WEB_MONETIZATION_MODAL = "WEB_MONETIZATION_MODAL",
	WEB_MONETIZATION_MODAL_GUI = "WEB_MONETIZATION_MODAL_GUI",
