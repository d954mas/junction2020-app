...
function Bar:animation_pulse()
	local scale = ACTIONS.Tween { object = self.vh.root, property = "scale", v3 = true, from = vmath.vector3(1), to = vmath.vector3(1.15), time = 0.2 }
	local scale2 = ACTIONS.Tween { object = self.vh.root, property = "scale", v3 = true, from = vmath.vector3(1.15), to = vmath.vector3(1), time = 0.2 }
