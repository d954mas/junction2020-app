...
function World:game_speed_set(speed)
    self.game_speed = assert(speed)
end

function World:game_speed_get()
    return self.game_speed
end

function World:game_speed_next()
    local speed = self:game_speed_get()
    if (speed == 1) then
        self:game_speed_set(1.5)
    elseif (speed == 1.5) then
        self:game_speed_set(2)
    else
        self:game_speed_set(1)
    end
end
