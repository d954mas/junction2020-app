...
M.INPUT_SELECTION_LEFT = hash("selection_left")
M.INPUT_SELECTION_RIGHT = hash("selection_right")
M.INPUT_SELECTION_UP = hash("selection_up")
M.INPUT_SELECTION_DOWN = hash("selection_down")
M.INPUT_SELECTION_PRESS = hash("selection_press")
...
M.MSG_UPDATE_WINDOW = hash("update window")
M.MSG_WINDOW_UPDATE = hash("window_update")
...
M.MSG_REGION_INIT_GUI = hash("msg_region_init_gui")
M.MSG_GUI_ERROR_SHOW = hash("msg_gui_error_show")
--region msg main_menu
